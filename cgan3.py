...
train_ipa = []
fields = ['word', 'ipa']
train_df = pandas.read_csv('data/small-words-10k-dataset.txt', encoding='utf-8', usecols=fields)
generative_df = pandas.read_csv('data/small-words-100-dataset.txt', encoding='utf-8', usecols=fields)
