...
train_ipa = []
fields = ['word', 'ipa']
train_df = pandas.read_csv('data/10000-5-letter-non-name-words-dataset.txt', encoding='utf-8', usecols=fields)
generative_df = pandas.read_csv('data/100-5-letter-non-name-words-dataset.txt', encoding='utf-8', usecols=fields)
