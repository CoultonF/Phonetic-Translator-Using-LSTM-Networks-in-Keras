...
def show_result(num_epoch, show = False, save = False, path = 'result.png', ):
    ...
    word_str=''
    ipa_str=''
    # for idx,ipa_spelling in enumerate(test_ipa):
    ipa_spelling=test_ipa[0]
    idx=0
    for letter in y_label_[idx]:
        word_str += idx_to_char[np.argmax(letter)]
    print(word_str)
    for letter in ipa_spelling:
...
onehot = one_hot_enc_gen(gen_df.word, char_to_idx, y_train.shape[1])
